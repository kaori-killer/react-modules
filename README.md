...
모달 UI 구현의 번거로움과 접근성 문제를 해결하기 위해 만들었습니다. Compound Component 패턴으로 유연한 사용과 기본 접근성 지원, 모달 상태 관리 훅을 제공합니다.
...
카드 번호, CVC, 만료일 등 복잡한 유효성 검증 로직 구현의 번거로움을 해결하기 위해 만들었습니다. 주요 카드사 자동 감지, 카드 브랜드별 유효성 검사 및 자동 포맷팅, 실시간 검증 및 에러 메시지 제공 기능을 제공합니다.
